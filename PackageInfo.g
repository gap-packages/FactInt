...
Version          := "1.4.8",
Date             := "17/05/2005",
ArchiveURL       := "http://www.cip.mathematik.uni-stuttgart.de/~kohlsn/factint/factint-1.4.8",
...
AbstractHTML     := Concatenation("This package provides routines for factoring integers, ",
                                  ...
                                  "  <li>Williams' <em>p<em>+1</li>\n  <li>The Elliptic Curves ",
                                  "Method (ECM)</li>\n  <li>The Continued Fraction Algorithm ",
                                  "(CFRAC)</li>\n  <li>The Multiple Polynomial Quadratic Sieve ",
                                  "(MPQS)</li>\n</ul>\n<p>It also provides access to Richard P. ",
                                  "Brent's tables of factors of integers of the form ",
                                  "<em>b</em>&circum;<em>k</em> +/- 1."),
