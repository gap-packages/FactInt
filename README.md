[![Build Status](https://github.com/gap-packages/FactInt/workflows/CI/badge.svg?branch=master)](https://github.com/gap-packages/FactInt/actions?query=workflow%3ACI+branch%3Amaster)
