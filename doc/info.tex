%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
%W  info.tex              GAP4 Package 'FactInt'              Stefan Kohl
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\Section{The Info Class 'IntegerFactorizationInfo'}

\index{Information about factoring process}
\index{IntegerFactorizationInfo}

To see what's going on during the factoring process, there is an 
Info Class `IntegerFactorizationInfo'.
(For the description of the Info mechanism, see the {\GAP} Reference
Manual).
...
value 2, then additionally all \lq relevant' steps in the factoring
...
For setting this InfoLevel, there is a shorthand `FactInfo( <level> )'.
